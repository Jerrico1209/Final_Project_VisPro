...
{
    public partial class UpdateDBFrm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                koneksi.Open();
                query = string.Format("select * from `data_mh_asrama` where `Nama Mahasiswa`='{0}'", txt_nama.Text);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                query = string.Format("UPDATE `data_mh_asrama` SET `Nama Mahasiswa`='{0}',`NIM Mahasiswa`='{1}',`Fakultas Mahasiswa`='{2}',`No_Kamar`='{3}', `Absen`='{4}' WHERE `Nama Mahasiswa`='{0}' ", txt_nama.Text, txt_NIM.Text, txt_Fakultas.Text, txt_No_kamar.Text, txt_absen.Text);
        ...
        private void UpdateDBFrm_Load(object sender, EventArgs e)
        { 
            try
            {
                koneksi.Open();
